		...
		<div class="wrapper wrapper-content animated fadeInRight">
			<div class="row">
				<div class="ibox float-e-margins">
					...
					<form action="<%=path%>/companyAdd.action" name="formAdd" 
						method="post">
						<div class="panel-body">
								...
								<div class="form-inline">
									...
									<div>
										...
										<div class="input-group" style="width:450px">
											<input required="required" name="lianxiren" type="text"
									...
									<div>
										...
										<div class="input-group" style="width:450px">
											<textarea  required="required" class="form-control wk-normal-input" name="address" rows="2" maxlength="200"></textarea>
