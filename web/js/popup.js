...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/wlgxglxt/img/dialogclose.gif  />';
   ...
   mainBox+='<tr style="height:'+this.config.height+'px;background-color: #fff;" valign="top"><td id="dialogBody" style="position:relative;"></td></tr></table></div>'+'<div id="dialogBoxShadow" style="display:none;z-index:'+baseZIndex+';"></div>';
