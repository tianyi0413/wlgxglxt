...
<script language="javascript">
    document.write("上传成功");
    var result = "/upload/<%= newFile1Name%>";
	window.parent.document.getElementById("fujian").value=result;
 
 	var imgComponent = window.parent.document.getElementById("tupian"); 
	if(imgComponent!=null){
		window.parent.document.getElementById("tupian").src ="<%=path%>"+result;
	}
